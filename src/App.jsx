...
const teamGroups = [
  ...
  { label: 'STRATEGY & DATA ANALYTICS', people: [['team-sebastian.jpg', 'Jose Miranda'], ['team-jorge.jpg', 'Félix Rizo'], ['team-eugenio.png', 'Sebastián Morales'], ['team-maricela.jpg', 'Jorge Rodríguez']] },
  ...
  return <div className="credentials-shell">
    ...
    <main>
      <section id="intro" data-section className="scene intro-scene is-revealed">
        ...
        <div className="intro-content"><InfinityMark /><h1>CREDENCIALES<br />2026</h1><p className="intro-copy">MEDIA &amp; BUSINESS STRATEGY · MEDIA BUYING · DATA ANALYTICS · BRAND EXPERIENCE</p><button className="scroll-cue" onClick={() => goTo('positioning')}>↓</button></div><p className="side-year">2026</p>
      </section>
      ...
      <section id="centralsimi" data-section className="scene simi-scene"><SceneTrace /><p className="section-number">07 — CENTRAL SIMI</p><div className="simi-copy"><img src="/centralsimi.webp" alt="CentralSimi" className="simi-logo" /><p>Agencia especializada y exclusiva del ecosistema Farmacias Similares, enfocada en la planeación estratégica y compra de medios publicitarios offline con integración digital, innovación comercial y expansión de activos de marca.</p></div><div className="simi-media"><img src="/estatua-simi.png" alt="Estatua Dr. Simi" /><div className="simi-stat"><strong>+15</strong><span>campañas<br />anuales</span><strong>+100</strong><span>socios<br />comerciales</span><strong>100%</strong><span>cobertura<br />nacional</span></div></div></section>
